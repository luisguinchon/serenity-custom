...
post_install() {
    ...
    echo '    Inside LXsystem: ~/.local/share/Serious-Engine/serioussam/'
    echo "    Outside LXsystem: ${SERENITY_SOURCE_DIR}/Base/home/anon/.local/share/Serious-Engine/serioussam/"
    echo
