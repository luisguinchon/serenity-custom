...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
    set(os "win32")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "LXsystem")
    set(os "serenity")
else()
    string(TOLOWER ${CMAKE_SYSTEM_NAME} os)
endif()

set(JAKT_COMPILER "${LXsystem_SOURCE_DIR}/Toolchain/Local/jakt/bin/jakt")
...
if(${PROJECT_NAME} STREQUAL "Lagom")
    ...
    set(JAKT_LIBRARY_BASE "${LXsystem_SOURCE_DIR}/Toolchain/Local/jakt/lib")
else()
    set(JAKT_LIBRARY_BASE "${LXsystem_SOURCE_DIR}/Toolchain/Local/jakt/usr/local/lib")
endif()
set(JAKT_LIBRARY_DIR "${JAKT_LIBRARY_BASE}/${JAKT_TARGET_TRIPLE}")
set(JAKT_INCLUDE_DIR "${LXsystem_SOURCE_DIR}/Toolchain/Local/jakt/usr/local/include/runtime")
...
if (ENABLE_JAKT)
    if (NOT EXISTS ${JAKT_COMPILER})
        ...
        set(all_includes
            ${INCLUDE_DIRECTORIES}
            ${LXsystem_SOURCE_DIR}
            ${LXsystem_SOURCE_DIR}/Userland/Libraries
            ${LXsystem_SOURCE_DIR}/Userland/Libraries/LibCrypt
            ${LXsystem_SOURCE_DIR}/Userland/Libraries/LibSystem
            ${LXsystem_SOURCE_DIR}/Userland/Services
            ${LXsystem_SOURCE_DIR}/Userland
        )
