 ...
 * Copyright (c) 2022, the LXsystem developers.
...
NonnullRefPtr<AboutDialog> AboutDialog::create(String const& name, String version, RefPtr<Gfx::Bitmap const> icon, Window* parent_window)
{
    ...
    // If we are displaying a dialog for an application, insert 'LXsystem' below the application name
    widget->find_descendant_of_type_named<GUI::Label>("serenity_os")->set_visible(name != "LXsystem");
